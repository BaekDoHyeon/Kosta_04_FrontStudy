 ...
 * FileName : MyBatisTestApp11.java
  ...
  * ㅇ Business Logic Layer(Service...) 단위 Test..여기서 에러난다고해도 mybatis-userservice-mapping10.xml는 볼 필요없다.
...
public class MyBatisTestApp11 {
	...
	public static void main(String[] args) throws Exception{
		...
		//3. MyBatisUserServiceImpl11.updateUser Test :: 주몽 ==> 온달 수정
		user.setUserName("온달");
		...
		System.out.println(":: 5. User10.removeUser (DELETE)  ? " + dao.removeUser(user.getUserId()) );
