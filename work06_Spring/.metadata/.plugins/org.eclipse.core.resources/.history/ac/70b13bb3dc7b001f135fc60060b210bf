...
//		BeanFactory factory = new XmlBeanFactory(new FileSystemResource("./src/main/resources/config/dicenService.xml"));
		// xml 하나씩 하면서 이곳에서 하나씩 테스트한다...
		ClassPathXmlApplicationContext factory = 
				new ClassPathXmlApplicationContext("./config/dicenService.xml");
