...
public class Boot05JpaRepositoryApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		*/
		...
		//2. 새로운 Custom 을 추가
		/*
		 * Custom c1 = new Custom(); c1.setName("한강"); c1.setEmail("hrever@naver.com");
		 * c1.setPassword("9898"); c1.setRegDate(LocalDateTime.now());
		...
		//customRepository.findByNameEndingWith("각").forEach(c -> System.out.print(c));
		//customRepository.findByCustomIdGreaterThanOrderByCustomIdDesc(1).get().forEach(c -> System.out.println(c));
		
		//findByNameNot
		customRepository.findByNameNot("김족각").forEach(c -> System.out.println(c));
		System.out.println("========================================================");
		customRepository.findByCustomIdIn(List.of(1, 10, 11)).get().forEach(c -> System.out.println(c));
	}
