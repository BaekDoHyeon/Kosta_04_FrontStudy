...
public class LoginFilter extends UsernamePasswordAuthenticationFilter { //폼값 받는 컨트롤러 역할의 필터
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
		...
		//3. token을 ~~Manager에 전달...Provider...DetailsService...db연결...CustomMemberDetails생성...Back/Back/Back...
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = jwtUtil.createJwt(customMemberDetails.getMember(), role, 1000L*60*10L); //1초*60*10 10분
