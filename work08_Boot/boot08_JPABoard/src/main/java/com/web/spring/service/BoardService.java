...
public class BoardService {
	...
	public BoardRes updateBoard(Long id, BoardReq board) throws DMLException {
		Board boardEntity = boardRepository.findById(id)
											.orElseThrow(() -> new DMLException("글번호 오류로 수정에 실패했습니다.", "Not Update!!"));
	...
	public String deleteBoard(Long id) {
		Board boardEntity = boardRepository.findById(id)
										.orElseThrow(() -> new DMLException("글번호 오류로 삭제에 실패하였습니다.", "Not Delete~!!", HttpStatus.BAD_REQUEST));
