...
public class GetController {
	...
	//2. http://localhost:9000/member?name=홍종각&address=종각, @RequestParam은 생략가능..
	@GetMapping("/member")
	...
	@GetMapping("/member/{name}/{address}")
	public String getMember2(@PathVariable String name, @PathVariable String address) {
		return name+" 님이 사는 곳은 " + address + "입니다.";
	}
}
