...
public interface DatabaseTemplate {
	...
	//비지니스 로직...특화된 로직
	void buyShares(String ssn, String symbol, int quantity)throws SQLException; //이미 가지고 있는 주식이라면 쿼리문은 UPDATE, 가지고 있는 주식이라면 INSERT
	void sellShares(String ssn, String symbol, int quantity)throws SQLException, InvalidTransactionException, RecordNotFoundException; //UPDATE, DELETE
